...
const Header = () => {
	const { score, compScore, counter, dispatch } = useContext(GameContext);
	...
	return (
		<header className="flex justify-between py-1 px-3 border-headerOutline rounded md:w-[60%] w-[90%] border m-auto items-center">
			<div>
				<p className=" text-lg font-bold md:text-xl capitalize text-white">
					rock
				</p>
				<p className=" text-lg font-bold md:text-xl capitalize text-white">
					paper
			...
			<div className="flex lg:gap-4 gap-2">
				<div className=" rounded-md bg-white   py-1 px-1 lg:py-2 lg:py-4 text-center">
					...
					<p className="font-bold text-xl lg:text-4xl text-darkText ">
						{score}
					</p>
				</div>
				<div className=" rounded-md bg-white  py-1 px-1 lg:py-2 lg:py-4 text-center">
					<p className="text-sm text-scoreText capitalize">comp. score</p>
					<p className="font-bold text-2xl lg:text-4xl text-darkText ">
						{compScore}
					</p>
				</div>
			</div>
